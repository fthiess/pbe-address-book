...
- **Auth:** any authenticated user.
- **Behavior:** invalidates the server-side session and clears the session cookie (and may emit `Clear-Site-Data`).
- **Response 204.**
