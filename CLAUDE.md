...
- `npm run verify:fast` — the **fast local lane** (gate-list sync, Biome, token drift, help-manual drift, typecheck, unit/integration tests). Run this as you iterate: it catches the great majority of mistakes in seconds, without the slow tail.
